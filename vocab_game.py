...
# 📌 จุดที่ 1: กำหนดค่าเริ่มต้นใน session_state (ข้อ 1-4)
...
# ----------------------------------------------------
# 📌 จุดที่ 8: รับพารามิเตอร์ ans1, ans2, ans3, ans4 เข้ามาใน Dialog
@st.dialog("📊 สรุปผลการเล่นเกม")
def show_result_dialog(ans1, ans2, ans3, ans4):
    st.balloons()
    score = 0

    # 📌 จุดที่ 3: แปลงคำตอบให้อยู่ในรูปแบบตัวพิมพ์เล็กและลบช่องว่าง
    ...
    # 📌 จุดที่ 5: เช็กคะแนนเต็ม score == 4
    if score == 4:
        st.success("🎉 You win!")
    else:
        st.error("💀 You lose!")
...
st.divider()
st.write("นางสาวธัญชนก ไชยมณี เลขที่ 24 ม.4/10")
